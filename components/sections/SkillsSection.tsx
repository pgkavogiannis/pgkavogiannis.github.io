...
export const SkillsSection: React.FC<SkillsSectionProps> = ({ languages, technologies, certifications }) => (
    <section id="skills" className="py-4 md:py-8 bg-gradient-to-br from-base-100 to-base-200">
        <ContainerLayout>
            <h2 className="text-3xl md:text-4xl font-bold mb-12 border-b-4 border-primary pb-4">Skills & Tech Stack</h2>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* Languages */}
                <div className="card bg-base-100 shadow-md border border-primary border-opacity-30">
                    <div className="card-body">
                        <h3 className="card-title text-2xl mb-6 text-primary">Languages</h3>
            ...
            {/* Certifications */}
            <div className="card bg-base-100 shadow-md border border-primary border-opacity-30 mt-8">
                <div className="card-body">
                    <h3 className="card-title text-2xl mb-6 text-primary">Certifications</h3>
